...
- Danh mục mục tiêu gồm khoảng `23` doanh nghiệp dược/y tế niêm yết trên `HOSE`, `HNX`, và `UPCOM`.
...
- Chuẩn hóa research workflow cho toàn bộ `23` mã thay vì lệ thuộc vào excel và phân tích thủ công.
