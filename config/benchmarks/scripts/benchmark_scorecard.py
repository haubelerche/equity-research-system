...
def main():
    ...
    counts = {
        ...
        'financial_facts': count_csv_rows(ROOT / 'shared/golden_financials/all_benchmark_facts_v3.csv'),
        'rag_queries': count_csv_rows(ROOT / '02_ragas_retrieval/golden_queries/golden_query_index_v3.csv'),
        'rag_chunks': len(read_jsonl(ROOT / '02_ragas_retrieval/golden_chunks/official_like_chunks_v3.jsonl')),
        'finance_cases': len(read_jsonl(ROOT / '03_financial_benchmarks/golden_valuation/finance_cases_v3.jsonl')),
        'agent_trace_cases': len(read_jsonl(ROOT / '04_deepeval_agent/deepeval_cases/agent_trace_cases_v3.jsonl')),
        'ops_traces': count_csv_rows(ROOT / '05_ops_cost_latency/golden_run_traces_v3.csv'),
    ...
    checks = {
        ...
        'has_fact_lineage': counts['financial_facts'] >= 1000,
    ...
    report = {'suite':'vn_pharma_benchmark_suite_20260615','score':round(score,2),'status':status,'checks':checks,'counts':counts}
