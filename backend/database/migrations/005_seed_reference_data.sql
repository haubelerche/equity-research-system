...
VALUES
    ...
    ('cogs.total',               'income_statement', 'Giá vốn hàng bán',                                   'Cost of goods sold',                   'vnd_bn'),
    ('gross_profit.total',       'income_statement', 'Lợi nhuận gộp',                                      'Gross profit',                         'vnd_bn'),
    ('sga.total',                'income_statement', 'Chi phí bán hàng và quản lý doanh nghiệp',           'SG&A expenses',                        'vnd_bn'),
    ...
    ('tax_expense.total',        'income_statement', 'Chi phí thuế thu nhập doanh nghiệp',                 'Income tax expense',                   'vnd_bn'),
    ...
    ('depreciation.total',       'income_statement', 'Khấu hao tài sản cố định',                           'Depreciation & amortisation',          'vnd_bn'),
    ('preferred_dividends.total','income_statement', 'Cổ tức ưu đãi',                                      'Preferred dividends',                  'vnd_bn'),
    -- Balance Sheet
    ...
    -- Market
    ('shares_outstanding.weighted_avg',  'market',        'Số cổ phiếu lưu hành bình quân gia quyền',      'Weighted average shares outstanding',  'shares'),
