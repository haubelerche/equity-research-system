...
SCOPE_FILE = ROOT / "config" / "dataset" / "mvp" / "mvp5_scope.yaml"
GOLDEN_SPEC = ROOT / "config" / "dataset" / "mvp" / "golden_facts_spec.yaml"
FACTS_FILE = ROOT / "config" / "dataset" / "mvp" / "financial_facts_bootstrap.csv"
...
def main() -> None:
    ...
    if not FACTS_FILE.exists():
        raise FileNotFoundError(
            f"{FACTS_FILE} not found. Run backend/dataset/bootstrap_mvp_facts.py first."
        )
