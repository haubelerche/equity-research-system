"""Catalyst source registry loader â€” Source-Provenance Rebuild, Phase 5.

Loads + validates config/source_registry.yaml. Only enabled, well-formed sources are
returned for fetching. This is the controlled allow-list â€” nothing outside it is fetched.
"""
