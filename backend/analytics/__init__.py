"""Working capital schedule â€” driver-based NWC and delta_nwc per forecast year.
...
Forecast NWC_t:
  AR_t  = ar_days  Ã— revenue_t / 365
  Inv_t = inv_days Ã— |cogs_t|  / 365
  AP_t  = ap_days  Ã— |cogs_t|  / 365
  NWC_t = AR_t + Inv_t - AP_t

delta_nwc_t = NWC_t - NWC_{t-1}
  Positive delta_nwc means working capital absorbed cash â†’ reduces FCF.

All monetary values in VND bn.
All arithmetic is deterministic Python â€” no LLM involvement.
"""
...
def build_working_capital_schedule(
    ...
    forecast_cogs: dict[str, float],          # {label: cogs_bn} â€” signed negative
    ...
    # â”€â”€ Historical drivers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    if ar_days is None:
        warnings.append(f"{ticker}: no historical AR data â€” AR forecast will be 0 (delta_nwc may be understated)")
    if inv_days is None:
        warnings.append(f"{ticker}: no historical inventory data â€” inventory forecast will be 0")
    if ap_days is None:
        warnings.append(f"{ticker}: no historical AP data â€” AP forecast will be 0 (delta_nwc may be overstated)")

    # â”€â”€ Forecast rows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
