...
File đề xuất: `config/eval/rag_golden_queries.yaml`
...
| P3 | Universe scaling readiness | Batch eval across pilot basket trước 23 hoặc 53 tickers |
...
| Tạo `config/eval/rag_golden_queries.yaml` | Benchmark retrieval lặp lại được |
...
| Retrieval | Có `rag_golden_queries.yaml`, hit-rate@5 được đo, evidence packet có page/source metadata |
