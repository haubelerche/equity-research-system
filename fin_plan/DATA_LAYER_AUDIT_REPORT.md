...
- **Superseded:** the project now uses Supabase PostgreSQL exclusively; local PostgreSQL fallbacks have been removed.
...
1. Supabase PostgreSQL connectivity must be confirmed through the required `DATABASE_URL`.
