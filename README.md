...
> Dự án lấy cảm hứng từ FinRobot nhưng được tái thiết kế cho **thị trường chứng khoán Việt Nam**, **dữ liệu tiếng Việt**, **cổ phiếu y dược Việt Nam**, **OpenAI API**, và **pipeline định giá có kiểm chứng nguồn**.
...
> Xây dựng hệ thống AI Agent có khả năng sinh bản nháp báo cáo phân tích và định giá cổ phiếu ngành y dược Việt Nam, trong đó mọi số liệu định lượng được tính bằng code, mọi nhận định quan trọng có nguồn, mọi giả định định giá được lưu vết, và báo cáo cuối được đánh giá bằng bộ kiểm thử chống hallucination.
