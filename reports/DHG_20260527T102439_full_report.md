...
Ngày tạo: 2026-05-27 10:24 UTC | Snapshot: `snap_e86b52a5f03d2d9475da`
...
|---|---|---|---|---|
| **DCF Blend (60% FCFF + 40% FCFE)** | **88,623 VND/CP** | 94,400 VND | **-6.1%** | **PRIMARY** |
...
Draft / Needs Analyst Review (model-implied downside: -6.1%)

> Căn cứ: upside Blend DCF = -6.1% | Ngưỡng BUY ≥ 20%, HOLD −10% đến +20%, SELL < −10%
...
> _Cảnh báo: No dividend data found (dividends_paid.total missing) — forecast assumes zero dividend payout. Equity may be overstated.; FCFF: WACCAssumptions.tax_rate=20.0% differs from TaxPolicy.effective_tax_rate=11.9% by 8.1%; using TaxPolicy rate for EBIT(1-T)_
...
| **Target Price DCF** | **88,623 VND/CP** | 100% | **88,623 VND/CP** |

| Chỉ tiêu | Giá trị |
|---|---|
| Giá thị trường hiện tại | 94,400 VND/CP |
| Target Price (60/40 blend) | 88,623 VND/CP |
| Upside / Downside | -6.1% |
| Margin of Safety | -6.5% |
| FCFF vs FCFE Gap | 3.1% [ok] |
...
|---|---|---|---|---|---|
| 79,687 | 78,623 | 80,623 | 82,623 | 84,623 | 86,623 |
| 84,687 | 81,623 | 83,623 | 85,623 | 87,623 | 89,623 |
| 89,687 | 84,623 | 86,623 | 88,623 | 90,623 | 92,623 |
| 94,687 | 87,623 | 89,623 | 91,623 | 93,623 | 95,623 |
| 99,687 | 90,623 | 92,623 | 94,623 | 96,623 | 98,623 |

_Vùng upside: [-16.7%, 4.5%] so với giá thị trường 94,400 VND/CP_
...
- **Định giá FCFF:** 89,687 VND/CP (upside -5.0%) | **FCFE:** 87,026 VND/CP (upside -7.8%) | **Blend 60/40:** 88,623 VND/CP (upside -6.1%) — chưa được phê duyệt.
- **Rating Draft:** Draft / Needs Analyst Review (model-implied downside: -6.1%) — chỉ có hiệu lực sau khi assumptions được analyst phê duyệt.
...
| ROE | 20.6% |
| Nợ/Vốn chủ | 0.3x |
| Giá Blend DCF (60% FCFF + 40% FCFE) | 88,623 VND/CP |
| Giá FCFF mục tiêu | 89,687 VND/CP |
| Giá FCFE mục tiêu | 87,026 VND/CP |
| Giá DCF base | 266,855 VND/CP |
| Draft Rating | Draft / Needs Analyst Review (model-implied downside: -6.1%) |
