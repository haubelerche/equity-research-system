...
Ngày tạo: 2026-05-27 10:01 UTC | Snapshot: `snap_e86b52a5f03d2d9475da`
...
|---|---|---|---|---|
| **DCF Blend (60% FCFF + 40% FCFE)** | **83,388 VND/CP** | 94,400 VND | **-11.7%** | **PRIMARY** |
| FCFF DCF (WACC mặc định) | 80,963 VND/CP | 94,400 VND | -14.2% | Thành phần blend |
| FCFE DCF (Re mặc định) | 87,026 VND/CP | 94,400 VND | -7.8% | Thành phần blend |
...
Draft / Needs Analyst Review (model-implied downside: -11.7%)

> Căn cứ: upside Blend DCF = -11.7% | Ngưỡng BUY ≥ 20%, HOLD −10% đến +20%, SELL < −10%
...
| Chỉ tiêu (tỷ VND) | 2022FY | 2023FY | 2024FY | 2025FY | 2026F | 2027F | 2028F | 2029F | 2030F |
|---|---|---|---|---|---|---|---|---|---|
| Tổng tài sản | 5,168.2 | 6,110.5 | 5,959.2 | 5,173.9 | **6,484.8** | **7,848.9** | **9,268.1** | **10,744.7** | **12,281.1** |
...
|---|---|---|---|---|
| Bear case | 187,660 | 12.0% | 2.0% | Chỉ tham khảo |
| Base case | 266,855 | 10.0% | 3.0% | Chỉ tham khảo |
| Bull case | 464,490 | 8.0% | 4.0% | Chỉ tham khảo |
...
|---|---|---|---|---|---|---|---|
| 2026F | 1,514.6 | 1,211.7 | 110.4 | 186.9 | 4.3 | 1,130.9 | 993.8 |
| 2027F | 1,575.9 | 1,260.7 | 114.8 | 194.4 | 4.4 | 1,176.7 | 908.6 |
| 2028F | 1,639.6 | 1,311.7 | 119.5 | 202.3 | 4.6 | 1,224.3 | 830.7 |
| 2029F | 1,706.0 | 1,364.8 | 124.3 | 210.5 | 4.8 | 1,273.8 | 759.5 |
| 2030F | 1,775.0 | 1,420.0 | 129.4 | 219.0 | 5.0 | 1,325.4 | 694.4 |

| | Tỷ VND |
|---|---|
| Tổng PV(FCFF) | 4,187.0 |
| Giá trị cuối kỳ (Terminal Value) | 12,640.1 |
| PV(Terminal Value) | 6,622.8 |
| Giá trị doanh nghiệp (EV) | 10,809.8 |
| Nợ ròng (Net Debt) | -129.9 |
| Giá trị vốn chủ (Equity Value) | 10,939.7 |
| Số cổ phiếu (triệu CP) | 135.1 |

**Giá mục tiêu FCFF: 80,963 VND/CP**
Upside so với giá thị trường: **-14.2%**
...
> _Cảnh báo: No dividend data found (dividends_paid.total missing) — forecast assumes zero dividend payout. Equity may be overstated.; FCFF: using WACCAssumptions.tax_rate=20.0% — no TaxPolicy object provided; may differ from forecast P&L effective tax rate_
...
|---|---|---|---|---|---|---|---|
| 2026F | 1,311.0 | 110.4 | 186.9 | 4.3 | 0.0 | 1,230.2 | 1,081.0 |
| 2027F | 1,364.0 | 114.8 | 194.4 | 4.4 | 0.0 | 1,280.0 | 988.4 |
| 2028F | 1,419.2 | 119.5 | 202.3 | 4.6 | 0.0 | 1,331.8 | 903.7 |
| 2029F | 1,476.6 | 124.3 | 210.5 | 4.8 | 0.0 | 1,385.7 | 826.2 |
| 2030F | 1,536.4 | 129.4 | 219.0 | 5.0 | 0.0 | 1,441.7 | 755.4 |

| | Tỷ VND |
|---|---|
| Tổng PV(FCFE) | 4,554.7 |
| Giá trị cuối kỳ (Terminal Value FCFE) | 13,750.0 |
| PV(Terminal Value) | 7,204.3 |
| Giá trị vốn chủ (Equity Value) | 11,758.9 |
| Số cổ phiếu (triệu CP) | 135.1 |

**Giá mục tiêu FCFE: 87,026 VND/CP**
Upside so với giá thị trường: **-7.8%**
...
|---|---|---|---|
| FCFF DCF | 80,963 | 60% | 48,578 |
| FCFE DCF | 87,026 | 40% | 34,810 |
| **Target Price DCF** | **83,388 VND/CP** | 100% | **83,388 VND/CP** |

| Chỉ tiêu | Giá trị |
|---|---|
| Giá thị trường hiện tại | 94,400 VND/CP |
| Target Price (60/40 blend) | 83,388 VND/CP |
| Upside / Downside | -11.7% |
| Margin of Safety | -13.2% |
| FCFF vs FCFE Gap | 7.0% [ok] |
| TV Weight (FCFF/EV) | 61.3% [ok] |

### Bảng sensitivity Blend (Price_FCFF × Price_FCFE → Target Price_DCF, VND/CP)

| FCFF \ FCFE | 77,026 | 82,026 | 87,026 | 92,026 | 97,026 |
|---|---|---|---|---|---|
| 70,963 | 73,388 | 75,388 | 77,388 | 79,388 | 81,388 |
| 75,963 | 76,388 | 78,388 | 80,388 | 82,388 | 84,388 |
| 80,963 | 79,388 | 81,388 | 83,388 | 85,388 | 87,388 |
| 85,963 | 82,388 | 84,388 | 86,388 | 88,388 | 90,388 |
| 90,963 | 85,388 | 87,388 | 89,388 | 91,388 | 93,388 |

_Vùng upside: [-22.3%, -1.1%] so với giá thị trường 94,400 VND/CP_
...
- **Định giá FCFF:** 80,963 VND/CP (upside -14.2%) | **FCFE:** 87,026 VND/CP (upside -7.8%) | **Blend 60/40:** 83,388 VND/CP (upside -11.7%) — chưa được phê duyệt.
- **Rating Draft:** Draft / Needs Analyst Review (model-implied downside: -11.7%) — chỉ có hiệu lực sau khi assumptions được analyst phê duyệt.
...
| ROE | 20.6% |
| Nợ/Vốn chủ | 0.3x |
| Giá Blend DCF (60% FCFF + 40% FCFE) | 83,388 VND/CP |
| Giá FCFF mục tiêu | 80,963 VND/CP |
| Giá FCFE mục tiêu | 87,026 VND/CP |
| Giá DCF base | 266,855 VND/CP |
| Draft Rating | Draft / Needs Analyst Review (model-implied downside: -11.7%) |
