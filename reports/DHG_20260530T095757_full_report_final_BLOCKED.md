...
> 25 quantitative claim chỉ có nguồn Tier 3 (API/provider) hoặc thiếu nguồn chính thức. Cần ingest tài liệu chính thức (BCTC/BCTN) và đối soát (Phase 3 + Phase 4) trước khi xuất bản final.
