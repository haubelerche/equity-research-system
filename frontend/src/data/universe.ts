...
export const UNIVERSE: UniverseTicker[] = [
  ...
  { ticker: "DRG", company_name: "Công ty Cổ phần Dược Rạch Giá", exchange: "UPCOM", segment: "pharma", is_mvp: false },
...
export function segmentCounts(): Record<UniverseTicker["segment"], number> {
