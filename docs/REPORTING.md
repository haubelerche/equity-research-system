...
Report model phải có claim ledger và source refs cho claim trọng yếu. `CITATION_GATE`, `citation_coverage_gate`, source tier policy và FPTS grade cùng kiểm soát việc xuất bản. Generic citation, Tier-3-only material facts và unsupported numeric claims là blocker.
