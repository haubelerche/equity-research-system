...
| [../eval/README.md](../eval/README.md) | Evaluation rollout plans cho data, RAG, finance, citation, agent, report quality, observability và CI | Architect, QA, product owner |
...
| P0 | Đọc `CURRENT_STATE_AND_UPDATES.md` trước khi dùng sơ đồ hoặc kế hoạch cũ | Tài liệu này ghi rõ các thay đổi mới và khoảng cách giữa diagnostic gate với runtime blocker |
...
| P0 | Dùng `../eval/` trước khi triển khai thay đổi evaluation mới | Bộ kế hoạch này mô tả thứ tự rollout và phân biệt deterministic blocker với LLM-as-judge advisory |
