...
| `backend/evaluation/` | Numeric consistency, citation coverage, source provenance, FPTS grade | Khi thay đổi quality rubric hoặc export blockers |
...
| Sửa export readiness | `backend/harness/gates.py`, `backend/evaluation/fpts_grade.py`, `config/harness/export_gate_policy.yml` |
