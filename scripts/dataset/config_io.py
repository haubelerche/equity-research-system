...
UNIVERSE_FILE = ROOT / "dataset" / "universe" / "pharma_vn_universe.csv"
FIN_TAXONOMY_FILE = ROOT / "dataset" / "taxonomy" / "financial_taxonomy_vn_pharma.yaml"
CATALYST_TAXONOMY_FILE = ROOT / "dataset" / "taxonomy" / "catalyst_taxonomy_vn_pharma.yaml"
