...
def _context_from_view_model(vm: ClientReportViewModel) -> ReportContext:
    ...
    return ReportContext(
        ...
        current_price=vm.current_price.amount if vm.current_price else 0.0,
        target_price=vm.target_price.amount if vm.target_price else 0.0,
        upside_pct=(vm.upside_downside.value * 100.0) if vm.upside_downside else 0.0,
